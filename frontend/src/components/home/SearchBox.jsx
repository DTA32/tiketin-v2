            ...
            <form onSubmit={formSubmit}>
              <div className="d-flex">
                  ...
                  <div className="mb-2 row">
                    ...
                    <div className="input-text-div ms-2 px-0 d-flex gap-2">
                      ...
                      >
                        ...
                        {towns.map((item) => (
                            <option key={item.kota} value={item.kota}>{item.kota}</option>
                        ))}
                      </select>
                    </div>
                  </div>
                ...
                <div className="w-25 d-flex align-items-center justify-content-center">
                    <FontAwesomeIcon icon={faArrowRightArrowLeft} rotation={90} size="xl" style={{cursor: "pointer"}} className='rounded-circle border border-black p-2' onClick={swapTown}/>
                </div>
              </div>
